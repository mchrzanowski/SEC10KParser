...
def __default_case_sensitive():
    ...
    '''
    return re.compile("^\s*ITEM\s*?3.*?(?=^\s*?ITEM\s*?(3A|4))", re.M | re.S), None
...
def __item_4_is_skipped_case_insensitive():
    return re.compile("^\s*ITEM\s*?3.*?(?=^\s*?ITEM\s*?[5-6])", re.M | re.S), re.compile("ITEM\s*4", re.I | re.M)
...
def __try_all_numbers_after_4_and_executive_listing():
    ...
    '''
    return re.compile("^\s*Item\s*?3.*?(?=(Item\s*?[5-6]|EXECUTIVE.*?OFFICERS?))", re.I | re.M | re.S), re.compile("ITEM\s*4", re.I | re.M)
...
def __item_3_is_last_item():
    ...
    '''
    return re.compile("^\s*ITEM\s*?3.*?(?=^\s*?EXECUTIVE.*?OFFICERS?)", re.I | re.M | re.S), re.compile("ITEM\s*4", re.I | re.M)

def __item_3_is_lodged_somewhere_case_sensitive_and_is_last_item_case_sensitive():
    return re.compile("ITEM\s*?3.*?(?=^\s*?EXECUTIVE.*?OFFICERS?)", re.M | re.S), re.compile("ITEM\s*4", re.I | re.M)
...
def __item_3_is_lodged_somewhere_case_sensitive_no_newlines():
    return re.compile("ITEM\s*?3.*?(?=ITEM\s*?(3A|4))", re.M | re.S), None

def __item_3_is_lodged_somewhere_and_is_last_item_case_sensitive_no_newlines():
    return re.compile("ITEM\s*?3.*?(?=EXECUTIVE.*?OFFICERS?)", re.M | re.S), re.compile("ITEM\s*4", re.I | re.M)

def __item_3_is_lodged_somewhere_and_item_4_is_skipped_case_sensitive_no_newlines():
    return re.compile("ITEM\s*?3.*?(?=ITEM\s*?[5-6])", re.M | re.S), re.compile("ITEM\s*4", re.I | re.M)
...
def __item_3_is_lodged_somewhere_case_insensitive_with_punctuation():
    ...
    return re.compile("(?<=[\.\?\!])\s\s+?ITEM\s*?3.*?(?=ITEM\s*?(3A|4))", re.I | re.M | re.S), None

def __item_3_is_lodged_somewhere_and_item_4_is_skipped_case_insensitive_with_punctuation():
    return re.compile("(?<=[\.\?\!])\s\s+?ITEM\s*?3.*?(?=ITEM\s*?[5-6])", re.I | re.M | re.S), re.compile("ITEM\s*4", re.I | re.M)

def __item_3_is_lodged_somewhere_and_is_last_case_insensitive_with_punctuation():
    return re.compile("(?<=[\.\?\!])\s\s+?ITEM\s*?3.*?(?=EXECUTIVE.*?OFFICERS?)", re.I | re.M | re.S), re.compile("ITEM\s*4", re.I | re.M)
...
def __item_3_is_lodged_somewhere_case_insensitive_with_punctuation_no_spaces():
    ...
    '''
    return re.compile("(?<=[\.\?\!])\s*?ITEM\s*?3.*?(?=ITEM\s*?(3A|4))", re.I | re.M | re.S), None

def __item_3_is_lodged_somewhere_and_item_4_is_skipped_case_insensitive_with_punctuation_no_spaces():
    return re.compile("(?<=[\.\?\!])\s*?ITEM\s*?3.*?(?=ITEM\s*?[5-6])", re.I | re.M | re.S), re.compile("ITEM\s*4", re.I | re.M)

def __item_3_is_lodged_somewhere_and_is_last_case_insensitive_with_punctuation_no_spaces():
    return re.compile("(?<=[\.\?\!])\s*?ITEM\s*?3.*?(?=EXECUTIVE.*?OFFICERS?)", re.I | re.M | re.S), re.compile("ITEM\s*4", re.I | re.M)
